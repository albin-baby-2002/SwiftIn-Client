            ...
            <Container>
              <div className=" flex flex-row items-center justify-between gap-3 md:gap-0">
                ...
                <div className="  flex  justify-end ">
                  <div className="relative flex  flex-row items-center justify-around  gap-3  rounded-xl   bg-black  px-3 py-2">
                    <button
                      onClick={() => {
        ...
        <main className="  pt-[120px]  sm:px-6   ">
          <div className=" mx-auto max-w-[1150px] ">
            ...
            <div className="   flex  items-center justify-center sm:mx-6 sm:w-auto ">
              <div className="  my-7      flex w-[90%]   flex-col items-center  justify-center rounded-xl border-black    bg-slate-50 text-center   shadow-lg sm:w-full sm:flex-row sm:text-start  ">
